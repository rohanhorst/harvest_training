...
# MAGIC %md
# MAGIC ###Excercise goal
# MAGIC We will connect to a Azure SQL Database from where we want to source data from the tables available.The goal is to retrieve data from one of the tables and save the data as a Delta Table.
...
# MAGIC
# MAGIC **Adventure Works database on Azure SQL Server**
# MAGIC
...
url = "jdbc:sqlserver://sqlsrv-training-01.database.windows.net:1433;database=sqldb-adventureworks-01"
...
# MAGIC
# MAGIC Save the table in the unity Catalog with the same name as your workspace in the default schema. When saving the table, postfix it with your initials.

# COMMAND ----------

remote_table.write.format("delta").saveAsTable("db_wrk_01.default.MY_PERMANENT_TABLE_NAME_Initials")
